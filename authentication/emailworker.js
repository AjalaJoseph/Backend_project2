...
dotenv.config();
const connection = new Redis({host:process.env.redis_host, port:process.env.redis_port,maxRetriesPerRequest: null})
const transporter = nodemailer.createTransport({
    service:'gmail',
    auth: {
        user: 'ajalaoluwafikayomi27@gmail.com',
        pass: 'nqlf uxet agyv nbsq'
    }
});
